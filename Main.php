                    ...
                    <form style="display:flex; flex-direction:column; " action="server/mmm.php" method="POST">
                      ...
                      <div  id="staffmembers">
                        ...
                        <div style="display:flex; flex-direction: column;">
                          ...
                          <input type="form-text" id="Sitep" name ="Sitep" class="form-control form-control-sm" placeholder="Select un publicateur">
                          
                          <small class="form-text text-muted">You can change your publicateur</small>
                          <label for="name">Editeur</label>
                          <input type="form-text" id="Sitee" name ="Sitee" class="form-control form-control-sm" placeholder="Select un editeur">
                          <small class="form-text text-muted">You can change your editeur </small>
                          <label for="name">Graphiste</label>
                          <input type="form-text" id="Siteg" name ="Siteg" class="form-control form-control-sm" placeholder="Select un Graphiste">
